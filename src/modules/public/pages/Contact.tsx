...
const Contact = () => {
  return (
    <div className="w-full h-auto ">
      <Nav />
      <div className="w-full h-auto mt-6 flex flex-col md:flex-row items-center  ">
        <div className=" mx-auto py-0 h-auto w-auto md:w-1/2">
          ...
          >
            ...
            <input
              type="text"
              placeholder="Subject"
              className=" w-full my-3  h-auto py-2 px-4 text-lg font-bold text-slate-800 rounded-md outline-none border-2 border-green-500 focus:border-lime-400"
            />
            ...
            <textarea
              ...
              id=""
              placeholder="Message..."
              className=" w-full my-3  h-auto py-3 px-4 text-base font-nunito text-slate-800 rounded-md outline-none border-2 border-green-500 focus:border-lime-400"
            ></textarea>
            <button
              type="submit"
